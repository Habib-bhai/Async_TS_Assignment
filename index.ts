...
async function fetchWithError(): Promise<string>{
  let prom: string = await new Promise((resolve,reject)=> {
    let condition= 0
...
async function main(func: ()=> Promise<string>){
...
async function executeSequentially(fnOne: ()=> Promise<string>,fnTwo:()=> Promise<string>){
...
//  The fetchData() function is already been made in the previous question.`
